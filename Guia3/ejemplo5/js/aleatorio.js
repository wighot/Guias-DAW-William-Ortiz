...
function init(){
    //Declaraci´´on del arreglo o matriz de forma literal 
    //que contendrá los npumeros aleatorios
    aleatorios = [];
    //Declaración y asignación de los limites entre los cuales estarán comprendidos los números aleatorios
