//Todo el módulo se encuentra dentro de una función conocida como función inmediata, en este caso también anónima que provoca que todo se ejecute de una vez.
...
(function(){
    ...
    //Registrar componentes de escucha del evento clic al presionar el botón denominado botonTirar y obtener todos los elementos img presentes en el documento
    function iniciar(){
    ...
    function establecerImagen(imgDado){
        ...
        imgDado.setAttribute("alt", "Imagen del dato con elvalor " + valorDado);
    }
})();